        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td> <img src=" <?php echo e(URL::to($row->image)); ?>" style="width:70px; height:40px;" alt=""></td>
                    <td>
                        <div class="btn-group">
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\blog\resources\views/post/allpost.blade.php ENDPATH**/ ?>